...
# ensure that the longer side length < max_size, shorter size > 256 if not, resize. return the h,w,ratio
...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='/home/datamining/Datasets/CrowdCounting/UCF-QNRF_ECCV18/',
                        help='original data directory')
    parser.add_argument('--data-dir', default='/home/datamining/Datasets/CrowdCounting/UCF-Train-Val-Test/',
